...
PRZYPISANIE BOX DO PALETY<BR><FONT COLOR='#22AA22'>ETYKIETA PALETY </FONT>
</center></font><hr>
";
?> 
<FORM ACTION="przypal_sprawdz1antolinsk.php" METHOD="POST" name="formularz">
<TABLE BORDER="0" ALIGN="center" BGCOLOR="#CCFFFF" CELLSPACING="0" CELLPADDING="0">
<TR>
<?php
echo"	<TD ALIGN='center' VALIGN='middle' HEIGHT='5'><font size='1'>Wczytaj kod Palety</TD>";
?>
</TR>
<TR>
