...
<FORM ACTION="parowanie_klient_kod_alc.php" METHOD="POST" name="formularz">
<TABLE BORDER="0" ALIGN="center" BGCOLOR="#CCFFFF" CELLSPACING="0" CELLPADDING="0">
<TR>
<?php
echo"	<TD ALIGN='center' VALIGN='middle' HEIGHT='5'><font size='1'>Wczytaj KOD ALC Z PRODUKTU <b>do WYSYLKI  $kodzam</b></TD>";
?>
</TR>
<TR>
