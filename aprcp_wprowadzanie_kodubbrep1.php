...
$kod_1 	= $_POST['kod_1'];
      ...
      $shinchang_part_no_1 = substr($kod_1, 8,$dlug_kor_1);
...
$qty_box_tot=$qty_box_1+1;
     ...
     $kwerenda5v = "SELECT * FROM prod_st WHERE barcode='$kod_1'";
     ...
     $lot_no_baza	 		= mysql_result($wynik5v, $t, "lot_no");
	  ...
	  elseif($shinchang_part_no_1!==$shinchang_part_no){ echo "<font size='0'>"; echo include "zatw_lokrep.php"; 
 	  ...
 	  elseif($lok_baza==="MG"){ echo "<font size='0'>"; echo include "zatw_lokrep.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>PUDELKO JEST JUZ NA REGALE /PAPECIE<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; 
						  }
      elseif ($lok_baza==="MW"){ echo "<font size='0'>"; echo include "zatw_lokrep.php"; 
      ...
      elseif ($lok_baza==="MP"){ echo include "zatw_lokrep.php";
							...
							";
							 echo $komunikat;}
	  elseif($qty_box<$qty_box_tot){ echo "<font size='0'>"; echo include "zatw_lokrep.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>ZA DUZA LUB ROWNA ILOSC PRODUKTOW W TYM PUDELKU! ZNAJDZ ODPOWIEDNIA ETYKIETE<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; 
						  }

        else {  echo "<font size='0'>"; echo include "zatw_lokrep2.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#00FF00'>WCZYTAJ KOD 2 ETYKIETY(OSTATNIEJ) DO REPAKU
							              ";
							echo "<font size='0'>$komunikat"; }
