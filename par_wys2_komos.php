...
<?php
echo"
<center><b><font size='1'> PAROWANIE ETYKIET - KLIENT PRODUKCJA<BR>ETYKIETA PRODUKCJA(2) DRUGA
<FONT COLOR='#0000bb'>  KLIENT $klient </b></center></font></font><hr>
";
?> 
 
<FORM ACTION="par_sprawdz2komos.php" METHOD="POST" name="formularz">
<TABLE BORDER="0" ALIGN="center" BGCOLOR="#CCFFFF" CELLSPACING="0" CELLPADDING="0">
<TR>
<?php
echo"	<TD ALIGN='center' VALIGN='middle' HEIGHT='5'><font size='1'>Wczytaj BARCODE z BOX(2) PRODUKCJA</TD>";
?>
</TR>
<TR>
