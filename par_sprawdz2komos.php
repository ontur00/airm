...
$barcodes=$_SESSION['sbarcodep'];
$part_nos=$_SESSION['spart_nop'];
$qty_boxs=$_SESSION['sqty_boxp'];
...
$haslo 		= 'robak1';
	...
	mysql_query('SET CHARSET latin2');
 	...
 	$kwerenda5reglkjts = "SELECT * FROM prod_parowaniekomos WHERE barcode='$kod' and no_deli='$kodzam'";
...
if($dlug_testp>0){ echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>SPRAWDZONA ETYKIETA !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($dlug_qty_box_pr<1){ echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>NIEPRAWILOWA LUB SPRZEDAZOWA ETYKIETA <BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($dlug_part_no_barcod<1){ echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>ETYKIETA NIEZAREJESTROWANA DO WYSYLKI !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($part_no!==$part_nos) { echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>NIEZGODNE REFERENCJE W ETYKIETACH !!!   !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($qty_box!==$qty_boxs) { echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>NIEZGODNE ILOSC W ETYKIETACH !!!   !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($barcodes!==$kod) { echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>NIEZGODNE KODY KRESKOWE ETYKIET !!!   !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
							     
 elseif(($part_no===$part_nos) and ($qty_box===$qty_boxs) and ($barcodes===$kod)){  session_start();
 						 						$_SESSION['sbarcodes']=$kod;
 						 						$_SESSION['spart_nos']=$part_no;
						 						$_SESSION['sqty_boxs']=$qty_box;
												echo include "zapisz_parowaniekomos.php"; 
							
												$komunikat = "<center><B><FONT COLOR='#00aa00'>etykieta PRODUKCYJNA DRUGA ok $qty_box<BR>  
							               							</center><hr>";
												echo $komunikat;
												}
	
	  else{ echo "<font size='0'>"; echo include "par_wys2_komos.php"; 
