...
$haslo 		= 'robak1';
	...
	mysql_query('SET CHARSET latin2');
 	...
 	$kwerenda5reglkjts = "SELECT * FROM prod_parowanieantolinsk WHERE barcode='$kod2' and no_deli='$kodzam'";
...
if($dlug_testp>0){ echo "<font size='0'>"; echo include "par_wys2_antolinsk.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>SPRAWDZONA ETYKIETA !!! <BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }			
elseif($dlug_qty_box_pr<1){ echo "<font size='0'>"; echo include "par_wys2_antolinsk.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>NIEPRAWILOWA LUB SPRZEDAZOWA ETYKIETA <BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($dlug_part_no_barcod<1){ echo "<font size='0'>"; echo include "par_wys2_antolinsk.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>ETYKIETA NIEZAREJESTROWANA DO WYSYLKI !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }							
elseif($part_nox!==$part_nos) { echo "<font size='0'>"; echo include "par_wys2_antolinsk.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>NIEZGODNE REFERENCJE W ETYKIETACH !!!   !!!<BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($qty_box!==$qty_boxs) { echo "<font size='0'>"; echo include "par_wys2_antolinsk.php"; 
 ...
 elseif(($part_nox===$part_nos) and ($qty_box===$qty_boxs)){  session_start();
												...
												echo include "zapisz_parowanieantolinsk.php"; 
	  ...
	  else{ echo "<font size='0'>"; echo include "par_wys2_antolinsk.php"; 
