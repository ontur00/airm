...
$kwerenda1 = "SELECT * FROM prod_got_wys WHERE barcode='$kod'";
$wynik1 = mysql_query($kwerenda1);
$rekordow1 = mysql_numrows($wynik1);
mysql_close();

echo "
<font size='4'><center><b> WYSYLKA ANTOLIN SK:</B> lokalizacja box </b></center></font><hr>";
...
<TR>
		...
		<TD ALIGN='center' BGCOLOR=$tlo><font size='1'>$loksz</font></TD>
			<TD ALIGN='center' BGCOLOR=$tlo><font size='1'>$barcodew</font></TD>
