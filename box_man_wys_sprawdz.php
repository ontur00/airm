...
elseif ($barcodeb!==$kodbox) {  echo "<font size='0'>"; echo include "wczyt_wys_man_pal.php"; 
  ...
  elseif ($lok_ba==="MG"){ 	 session_start();
                                                               $login=$_SESSION['luzytkownik'];
                                                                $magazyn1="MW";
																$powod="M_BOX-WYS";
							...
							$komunikat = "<center><B><font size='1'><FONT COLOR='#00aa00'>OK $part_no BOX DODANY DO WYSYLKI<BR> PODAJ NR WYSYLKI  
							              ";
							echo "<font size='0'>$komunikat"; }						
							
  else{    echo "<font size='0'>"; echo include "wczyt_wys_man_pal.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>BOX NIE JEST ZAREJESTROWANA W SYSTEMIE <BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
