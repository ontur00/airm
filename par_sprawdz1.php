...
$haslo 		= 'robak1';
	...
	mysql_query('SET CHARSET latin2');
 	...
 	$kwerenda5reglkjts = "SELECT * FROM prod_parowanie WHERE barcodes='$kod'";
...
if($dlug_testp >0){ echo "<font size='0'>"; echo include "par_wys.php"; 
...
elseif(($dlug_qty_box_pr>0) and (($klients===$klient_pr)or($klient_pr==='MOBIS'))) 
						 ...
						 $_SESSION['sqty_boxs']=$qty_box;
							echo include "par_wys2.php"; 
							
						$komunikat = "<center><B><FONT COLOR='#00aa00'>etykieta sprzedazowa ok $qty_box<BR>  
							               							</center><hr>";
						echo $komunikat;
						}	
elseif($dlug_testp >0){ echo "<font size='0'>"; echo include "par_wys.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>SPRAWDZONA ETYKIETA !!! <BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; 
							 }	
 	
	  else{ echo "<font size='0'>"; echo include "par_wys.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>TO NIE JEST ETYKIETA SPRZEDAZOWA !!! <BR></FONT><FONT COLOR='#0000FF'> ZESKANUJ JESZCZE RAZ !!! 
							              ";
							echo "<font size='0'>$komunikat"; }	
