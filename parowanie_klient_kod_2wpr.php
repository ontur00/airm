...
<FORM ACTION="parowanie_klient_kod_2spr.php" METHOD="POST" name="formularz">
<TABLE BORDER="0" ALIGN="center" BGCOLOR="#CCFFFF" CELLSPACING="0" CELLPADDING="0">
<TR>
<?php
echo"	<TD ALIGN='center' VALIGN='middle' HEIGHT='5'><font size='1'>Wczytaj BARCODE 2 DRUGIEJ ETYKIETY KLIENTA<b>do WYSYLKI  $kodzam</b></TD>";
?>
</TR>
<TR>
