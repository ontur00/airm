...
elseif ($kodpal_baza!==$kodpal) {  echo "<font size='0'>"; echo include "wczyt_wys_man_pal.php"; 
  ...
  elseif ($lok_ba==="MW"){ echo "<font size='0'>"; echo include "wczyt_wys_man_pal.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>PALETA JEST PRZYGOTOWANA DO WYSYLKI<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
  ...
  elseif ($lok_ba==="MG"){ 
                                                               ...
                                                               $login=$_SESSION['luzytkownik'];
																...
																$kwerenda = "SELECT * FROM prod_st WHERE lok_sc='$kodpal'";
																...
																if($lok_sc_b===$kodpal){
                                                                						...
                                                                						@mysql_select_db($baza) or die("Nie odnaleziono bazy danych!");
                                                                 						...
                                                                 						VALUES ('$nr_zam_wys','$shinchang_part_no_b','$part_no_b','$part_name_b','$stan_glw','$stan_glw_rob','$klient_b','$lok_sc_b','$lok_b','$login','$powod','$barcode_b','$lok_pal_b')";
                                                                  						mysql_connect('localhost',$uzytkownik,$haslo);
                                                                 						mysql_query("SET NAMES 'latin2'");
                                                                 						mysql_query("SET CHARACTER SET 'latin2_general_ci'");
                                                                						@mysql_select_db($baza) or die("Nie odnaleziono bazy danych!");
							...
							$komunikat = "<center><B><font size='1'><FONT COLOR='#00aa00'>OK PALETA ZAREJESTROWANA DO WYSYLKI<BR>  
							              ";
							echo "<font size='0'>$komunikat"; }							
