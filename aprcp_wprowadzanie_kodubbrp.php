...
elseif ($kodpal==="."){ echo "<font size='0'>"; echo include "aprcp_z_czytnikabbr.php"; 
					$komunikat = "<center><B><FONT COLOR='#00aa00'><font size='1'> WCZYTAJ KOD PUDELKA Z PRODUKTAMI </center></b><hr>";
																	echo $komunikat;}
...
if ($kodpal_baza!==$kodpal) {  echo "<font size='0'>"; echo include "aprcp_z_czytnikabbrp.php"; 
							...
							WCZYTALES NIEPRAWIDŁOWY KOD KRESKOWY PALETY<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
elseif($dllok_baza>1){ echo "<font size='0'>"; echo include "aprcp_z_czytnikabbrp.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>PALETA JEST JUZ NA REGALE <BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
  /*elseif ($lok_ba==="MW"){ echo "<font size='0'>"; echo include "aprcp_z_czytnikabbrp.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>PALETA JEST PRZYGOTOWANE DO WYSYLKI<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }*/
  else{ 
                                    
																			 echo include "zatw_lokrp.php";
                                                                 $komunikat = "<center><B><FONT COLOR='#00aa00'><font size='1'>Zarejestruj PALETE<b> $part_no</b> na lokalizacji <br><b><font size='5'></center></b><hr>";
																	echo $komunikat;}
