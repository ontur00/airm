...
$haslo 		= 'robak1';
 ...
 elseif($lok_baza==="MP"){ echo "<font size='0'>"; echo include "czyt_part_rework.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>PUDELKO NIE JEST PRZYJETE NA REGAL /PAPECIE<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
  elseif ($lok_baza==="MW"){ echo "<font size='0'>"; echo include "czyt_part_rework.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#FF0000'>PUDELKO JEST PRZYGOTOWANE DO WYSYLKI<BR> ZAREJESTRUJ OPERACJE JESZCZE RAZ. 
							              ";
							echo "<font size='0'>$komunikat"; }
  elseif ($lok_baza==="PR"){ echo "<font size='0'>"; echo include "czyt_part_rework.php"; 
  ...
  elseif ($lok_baza==="MG"){ 
                                                               ...
                                                               $login=$_SESSION['luzytkownik'];
																...
																$shinchang_part_no_b 	= mysql_result($wynik, 0, "shinchang_part_no");
                                                                						...
                                                                						@mysql_select_db($baza) or die("Nie odnaleziono bazy danych!");
                                                                 						...
                                                                 						mysql_close();
                                                                 						$kwerenda_zapw_max2 = "INSERT INTO prod_got_rework(pojazd,shinchang_part_no,part_no,part_name,stan_pop,stan,klient,nr_lok,pole_odkl,login,powod,barcode,lok_pal)
                                                                 						VALUES ('$p','$shinchang_part_no_b','$part_no_b','$part_name_b','$stan_glw','$stan_glw_rob','$klient_b','$lok_sc_b','$lok_b','$login','$powod','$barcode_b','$lok_pal_b')";
                                                                  						mysql_connect('localhost',$uzytkownik,$haslo);
                                                                 						mysql_query("SET NAMES 'latin2'");
                                                                 						mysql_query("SET CHARACTER SET 'latin2_general_ci'");
                                                                						@mysql_select_db($baza) or die("Nie odnaleziono bazy danych!");
                                                                						...
                                                                						mysql_close();
                                                                							$kwerenda_max = "UPDATE prod_got SET stan='$stan_glw_rob' WHERE shinchang_part_no='$shinchang_part_no_b'";	
                                                                						mysql_connect('localhost',$uzytkownik,$haslo);
                                                                						mysql_query("SET NAMES 'latin2'");
                                                                						mysql_query("SET CHARACTER SET 'latin2_general_ci'");
                                                                						@mysql_select_db($baza) or die("Nie odnaleziono bazy danych!");
                            ...
                            $komunikat = "<center><B><FONT COLOR='#00aa00'><font size='1'>PUDELKO <b> $part_no WYSLANE Z MAGAZYNU DO REWORK</b> <br>
							              </center><hr>";	
							echo $komunikat;}
													  						

 else {  echo "<font size='0'>"; echo include "czyt_part_rework.php"; 
