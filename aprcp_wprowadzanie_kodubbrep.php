...
echo "<font size='0'>$komunikat"; 
      ...
      elseif($lok_baza==="MG"){ echo "<font size='0'>"; echo include "zatw_lokrep.php"; 
							$komunikat = "<center><B><font size='1'><FONT COLOR='#00FF00'>WCZYTAJ KOD BOX Z PUDELKA 1 (PIERWSZE) DO PRZEPAKU. 
							              ";
							echo "<font size='0'>$komunikat"; 
						  }
      elseif ($lok_baza==="MW"){ echo "<font size='0'>"; echo include "aprcp_z_czytnikabbrep.php"; 
      ...
      elseif ($lok_baza==="MP"){ echo include "aprcp_z_czytnikabbrep.php";
        ...
        else {  echo "<font size='0'>"; echo include "aprcp_z_czytnikabbrep.php"; 
