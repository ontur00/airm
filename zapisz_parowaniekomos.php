...
$haslo 		= 'robak1';
	...
	mysql_query('SET CHARSET latin2');
 	...
 	$part_name	 			= mysql_result($wynik5reglkjt, 0, "part_name");
																						...
																						$kwerenda_zap_max = "INSERT INTO prod_parowaniekomos(part_no,part_name,stan,login,powod,barcode,barcodes,no_deli)
                                                                 						VALUES ('$part_no','$part_name','$qty_boxp','$login','parowanie','$kodp','$kods','$kodzam')";
                                                                  						mysql_connect('localhost',$uzytkownik,$haslo);
	 ...
	 echo include "par_wys_komos.php"; 
