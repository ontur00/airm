...
$kwerenda1 = "SELECT * FROM prod_st WHERE lok='MG' and   shinchang_part_no='$shinchang_part_no'";
$wynik1 = mysql_query($kwerenda1);
$rekordow1 = mysql_numrows($wynik1);
mysql_close();
echo "
<font size='4'><center><b> MAGAZYN GLOWNY:</B> Referencje na lokalizacji </b></center></font><hr>";
...
mysql_close();
echo "
<font size='4'><center><b>BOX na MAGAZYN PRODUKCJA:</B> Referencje na lokalizacji MG</b></center></font><hr>";
...
$lokzap="lok='MG'";
$part_noza="part_no='$part_no_z'";
$kwerenda1 = "SELECT * FROM prod_st WHERE lok='ZB' and   shinchang_part_no='$shinchang_part_no'";
$wynik1 = mysql_query($kwerenda1);
$rekordow1 = mysql_numrows($wynik1);
mysql_close();
echo "
<font size='4'><center><b> MAGAZYN ZABLOKOWANE:</B> Referencje na lokalizacji </b></center></font><hr>";
}
...
<TABLE BORDERCOLOR='#000000' CELLSPACING='0' WIDTH='240' BORDER='0' ALIGN='center'>
 ...
 <TH><font size='1'>ilosc</font></TH>
  <TH><font size='1'>lokalizacja </font></TH>
   <TH><font size='1'>lok palety </font></TH>
...
$loksz						= mysql_result($wynik1, $a, "lok_sc");
...
<TR>
		...
		<TD ALIGN='center' BGCOLOR=$tlo><font size='1'>$loksz</font></TD>
			<TD ALIGN='center' BGCOLOR=$tlo><font size='1'>$lok_pal</font></TD>
...
<HR>
<font size='1'><center>STAN W/G LOKALIZACJI: <B>$stanlok </b> STAN W/G SYSTENU: <B>$stan_gl</b><br> ILOSC BOX: <B>$il_box</b> </font>
<HR>

<HR></center>
";
?>
<FORM ACTION="zaw_wczytaj.php" METHOD="POST" name="formularz">
