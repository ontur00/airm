...
$plddplp=$_SESSION['s_nr_ppalety_antolinsk'];
?>
</HEAD>
...
<?php
echo"
<center><b><font size='1'> PAROWANIE PALET <font color='#2244ff'>$plddplp </font><br>DO ETYKIET PALETOWYCH <BR>ETYKIETA PALETY ANTOLIN SK
<FONT COLOR='#0000bb'> </b></center></font></font><hr>
";
?> 
<FORM ACTION="par_ppaletsprawdz1antolinsk.php" METHOD="POST" name="formularz">
<TABLE BORDER="0" ALIGN="center" BGCOLOR="#CCFFFF" CELLSPACING="0" CELLPADDING="0">
<TR>
<?php
echo"	<TD ALIGN='center' VALIGN='middle' HEIGHT='5'><font size='1'>Wczytaj kod Palety ANTOLIN SK</TD>";
?>
</TR>
<TR>
