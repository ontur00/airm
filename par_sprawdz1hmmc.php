...
mysql_connect('localhost',$uzytkownik,$haslo);
	mysql_query('SET CHARSET latin2');
 	...
 	$kwerenda5reglkjtskms = "SELECT * FROM prod_imp_hmmc WHERE barcodep='$kod' and nr_zams='$kodzam'";
	...
	$dlug_testph = strlen($part_no_b);

mysql_connect('localhost',$uzytkownik,$haslo);
	mysql_query('SET CHARSET latin2');
 	@mysql_select_db($baza) or die("Nie można znaleć bazy danych!");
 	$kwerenda5reglkjts = "SELECT * FROM prod_parowaniehmmc WHERE barcodes='$kod'";
